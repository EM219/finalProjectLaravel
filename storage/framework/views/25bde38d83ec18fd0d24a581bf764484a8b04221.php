            ...
            <?php if(Route::has('login')): ?>
                <div class="top-right links">
                    <?php if(auth()->guard()->check()): ?>
                        <a class="link" href="<?php echo e(('/home')); ?>">Home</a>

                    <?php else: ?>
                        <a class="link" href="<?php echo e(route('login')); ?>">Login</a>
                        <br>
...
</html><?php /**PATH C:\xampp db\htdocs\finalProject\resources\views/welcome.blade.php ENDPATH**/ ?>